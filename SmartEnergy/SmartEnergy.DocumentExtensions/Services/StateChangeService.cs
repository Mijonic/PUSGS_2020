...
namespace SmartEnergy.Service.Services
{
    ...
    {
        private readonly DocumentExtensionsDbContext _dbContext;
        private readonly IMapper _mapper;
        private readonly IAuthHelperService _authHelperService;

        public StateChangeService(DocumentExtensionsDbContext dbContext, IMapper mapper, IAuthHelperService authHelperService)
        {
